...
const deleteActionLink = document.querySelectorAll('.dashboard-delete-action-link');
const restoreActionLink = document.querySelectorAll('.dashboard-restore-action-link');
const forceDeleteActionLink = document.querySelectorAll('.dashboard-force-delete-action-link');

if (deleteActionLink) {
    deleteActionLink.forEach(btn => {
        btn.addEventListener('click', function (e) {
            e.preventDefault();
            const formId = this.dataset.formid;
            const form = document.getElementById('dashboard-delete-action-form-' + formId);
            form.submit();
        });
    });
}
